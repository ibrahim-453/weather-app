import {Eye,Wind,Droplets,Sun,MapPin} from "lucide-react";
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="relative mb-6">
            ...
            <img
              ...
              className="relative w-35 h-35 sm:w-32 sm:h-32 lg:w-40 lg:h-40 object-contain drop-shadow-lg"
            />
          </div>
      ...
      <div className="bg-white/15 backdrop-blur-xl shadow-2xl rounded-3xl border border-white/20 p-6 sm:p-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between p-4 bg-white/10 rounded-2xl border border-white/10 w-full">
